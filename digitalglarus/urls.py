...
urlpatterns = [
    ...
    url(_(r'users/billing_address/?$'), digitalglarus_views.UserBillingAddressView.as_view(),
        name='user_billing_address'),
    url(_(r'booking/?$'), digitalglarus_views.BookingSelectDatesView.as_view(), name='booking'),
    url(_(r'booking/payment/?$'), digitalglarus_views.BookingPaymentView.as_view(),
    ...
    url(_(r'membership/reactivate/?$'), digitalglarus_views.MembershipReactivateView.as_view(),
